                    ...
                    <tbody>
                        {smsHistory.map((data, index) => (
                            <tr className="text-black  bg-white shadow-custom-backend rounded-lg my-10 " key={index}>
                                ...
                                <td className="lg:text-xl py-5">{data.nickname}</td>
                                <td className="lg:text-xl py-5">{data.batch}</td>
                                <td className="lg:text-xl py-5">{data.mobile}</td>
                                <td className="lg:text-xl py-5">{moment(data.createdAt).format("DD MMM YYYY")}</td>
                                <td className="lg:text-xl py-5">{data.messageType}</td>
