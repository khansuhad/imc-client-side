...
const BatchEntry = () => {
  ...
  // setLoadingButton(true)
        ...
        //(formInfo);
        useAXios.post("/batches" , formInfo)
      .then(res => {
        form.reset()
    ...
    return (
        ...
        <div className="mt-2">
           ...
           <select id="dropdown" name="studentClass"  className="block border-[1px]  p-1  lg:text-[16px] mt-2 w-full rounded border-[#9E9E9E] font-medium outline-none  " required>
        ...
        Starting Date
          ...
          <div className="mt-2">
           ...
           <select id="dropdown2" name="status" defaultValue={`Ongoing`} placeholder="Ongoing" className="block border-[1px]  p-1 font-light lg:text-[16px] mt-2 w-full rounded border-[#9E9E9E] text-black" >
           <option >...</option> 
