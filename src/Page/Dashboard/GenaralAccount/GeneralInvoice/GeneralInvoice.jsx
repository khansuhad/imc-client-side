        ...
        <div className="py-20 bg-background-gradient min-h-screen">
              ...
              <div className="h-[277px] border-[0.5px] rounded-[12px] border-[#D7DAE0] p-[16px]">
                      ...
                      <div className="mt-[25px]">
                       ...
                       <div className="text-[10px] grid grid-cols-3 gap-[10px]">
                         <h1>{data?.category}</h1>
                         <h1 className="text-center">{data?.transectionMode}</h1>
                         <h1 className="text-right">{data?.cashReceived}</h1>
                       </div>
                       ...
                       <div className="text-[10px] grid grid-cols-3 gap-[10px]">
                         ...
                         <h1 className="text-right text-black font-semibold">{data?.cashReceived}</h1>
                         </div>
                       </div>
                      </div>
